                ...
                <Table class='bg-transparent ' responsive bordered striped hover>
                    ...
                    <tbody>
                        <tr className='text-[#CACACA]'>
                            <td style={{ padding: '10px', display: 'flex', gap: "6px" }}>   <img src="tablepic.svg" alt="Image Description" className='bg-white rounded-full' />jimmy</td>
                        ...
                        <tr className='text-[#CACACA]'>
                            <td style={{ padding: '10px', display: 'flex', gap: "6px" }}>   <img src="tablepic.svg" alt="Image Description" className='bg-white rounded-full' />jamshaid</td>
